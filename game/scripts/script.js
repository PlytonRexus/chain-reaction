...
var width = window.arenaWidth;
var height = window.arenaHeight;
...
button.addEventListener("click", function(e) {
    ...
    let nev = MouseEvent("click", new_event);
...
function drawArena() {
    ...
    if (turnCount % 2 == 0)
        ...
        turnIndicator.style.color = "green", turnIndicator.innerHTML = "Player 2 turn";
